...
const employeeTCS = employeeArray.filter((Employee) => {
...
const tcsEmployees = employeeArray.filter((Employee) => {
    return Employee.emp_company === 'TCS';
});
const employeeTcsName = tcsEmployees.map((Employee) => {
    return Employee.emp_name;
});
console.log(employeeTcsName);

console.log(`**************************************************************************************************************`);
 employeeArray.filter(Employee => Employee.emp_company === 'TCS')
 .map(employee => employee.emp_name)
.forEach(empName => console.log(empName));

console.log(`...........................Find the average salary of employee from company Wipro..................`);//interview
...
console.log(`.......................Find the average salary of employee from company Wipro or Infy.................`);
const employees = employeeArray.filter((Employee) => {
